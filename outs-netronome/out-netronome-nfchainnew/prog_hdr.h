...
__packed struct context_chain_1_t {
	...
	uint16_t f4;
	uint32_t f5;
	struct connect_tracker_meta_header_t f6;
	uint16_t f7;
	struct tcp_tracker_t f8;
	struct connect_tracker_meta_header_t f9;
};
...
#define WORKQ_ID_NET_RECV_3_1 5
CLS_WORKQ_DECLARE(workq_NET_RECV_3_1, WORKQ_SIZE_NET_RECV_3);

#define WORKQ_SIZE_NET_RECV_2 512
#define WORKQ_TYPE_NET_RECV_2 MEM_TYEP_CLS
#define WORKQ_ID_NET_RECV_2_1 6
CLS_WORKQ_DECLARE(workq_NET_RECV_2_1, WORKQ_SIZE_NET_RECV_2);

#define WORKQ_SIZE_NET_RECV_1 512
#define WORKQ_TYPE_NET_RECV_1 MEM_TYEP_CLS
#define WORKQ_ID_NET_RECV_1_1 7
