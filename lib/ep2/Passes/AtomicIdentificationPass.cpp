...
// TODO(): this should be an forward dataflow analysis pass
namespace {
...
struct LoadModifyWritePattern : public RewritePattern {
  ...
  virtual LogicalResult matchAndRewrite(Operation *op,
    ...
    // TODO(): for this transformation, we only need to check the users
...
void AtomicIdentificationPass::runOnOperation() {
    ...
    moduleOp.walk([&](FuncOp funcOp) {
      if (!funcOp->getAttr("scope"))
        return;
      // TODO(): keep track of interested gloabl vars
