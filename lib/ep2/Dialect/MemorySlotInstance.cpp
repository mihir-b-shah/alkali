...
void rewriteNextInit(RewriterBase &rewriter, Value value) {
  ...
  // TODO(): Check this. Will we see an "end"?
...
// TODO(): check this. when do they use this call?
...
Value ContextRefOp::getDefaultValue(const MemorySlot &slot, RewriterBase &rewriter) {
  ...
  // TODO(): add assert or warning here?
...
// TODO(): type check may block the conversion. Make sure we got all type infered!
